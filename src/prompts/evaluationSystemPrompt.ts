...
2. "PARTIALLY_CORRECT":
   - Criteria: The learner demonstrates a meaningful subset of milestones (e.g., 2/4 or 3/4) but leaves essential quantitative bounds, trade-off calculations, or core criteria unaddressed.
...
4. "NEEDS_CLARIFICATION":
   - Criteria: The submission cannot be classified as a substantive technical attempt.
   - Triggers:
   ...
   - Rule: When returning "NEEDS_CLARIFICATION", set demonstrated_capabilities to [], and list all milestones under missing_capabilities.
